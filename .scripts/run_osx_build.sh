...
validate_recipe_outputs "terraform-provider-opsgenie-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-opsgenie-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi